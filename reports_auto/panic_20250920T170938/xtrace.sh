...
try:
    ...
    np = None  # allow sanitizer to still work
...
def score_file(path: Path, vocab: set[str]):
...
def label_dist(path: Path):
    dist = Counter()
    for ln in sample_lines(path, limit=5000):
...
[ -n "$LATEST" ] && { sed -n "1,40p" "$LATEST/TOP_INTENT.tsv"; echo; sed -n "1,40p" "$LATEST/TOP_SPAM.tsv"; } || true
'
++ tee -a reports_auto/panic_20250920T170938/python_stderr.txt
+ ec=1
+ set -e
...
[ -n "$LATEST" ] && { sed -n "1,40p" "$LATEST/TOP_INTENT.tsv"; echo; sed -n "1,40p" "$LATEST/TOP_SPAM.tsv"; } || true
'
+ echo '- LOG  : reports_auto/panic_20250920T170938/run.log'
+ echo '- ERR  : reports_auto/panic_20250920T170938/run.err'
+ echo '- PY   : reports_auto/panic_20250920T170938/python_stderr.txt'
+ echo '- OOM  : reports_auto/panic_20250920T170938/oom.txt'
+ echo '- TRACE: reports_auto/panic_20250920T170938/xtrace.sh'
+ echo '- SYS  : reports_auto/panic_20250920T170938/system.txt'
+ echo
+ echo '## Heuristics'
+ grep -qi 'only one class' reports_auto/panic_20250920T170938/run.err reports_auto/panic_20250920T170938/python_stderr.txt
+ grep -qi 'No module named '\''tools'\''' reports_auto/panic_20250920T170938/run.err reports_auto/panic_20250920T170938/python_stderr.txt
+ grep -qi 'Can'\''t get attribute '\''rules_feat' reports_auto/panic_20250920T170938/run.err reports_auto/panic_20250920T170938/python_stderr.txt
+ grep -qi Killed reports_auto/panic_20250920T170938/run.err reports_auto/panic_20250920T170938/python_stderr.txt
+ grep -qi 'out of memory' reports_auto/panic_20250920T170938/oom.txt
+ echo
+ echo '=== DIAG OUTPUTS ==='
+ printf '%s\n' reports_auto/panic_20250920T170938/REPORT.md reports_auto/panic_20250920T170938/run.log reports_auto/panic_20250920T170938/run.err reports_auto/panic_20250920T170938/python_stderr.txt reports_auto/panic_20250920T170938/xtrace.sh reports_auto/panic_20250920T170938/system.txt reports_auto/panic_20250920T170938/oom.txt
+ echo
+ exit 1
