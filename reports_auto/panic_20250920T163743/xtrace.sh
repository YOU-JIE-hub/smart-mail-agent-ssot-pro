...
[ -n "$LATEST" ] && { sed -n "1,40p" "$LATEST/TOP_INTENT.tsv"; echo; sed -n "1,40p" "$LATEST/TOP_SPAM.tsv"; } || true
'
++ tee -a reports_auto/panic_20250920T163743/python_stderr.txt
+ ec=1
+ set -e
...
[ -n "$LATEST" ] && { sed -n "1,40p" "$LATEST/TOP_INTENT.tsv"; echo; sed -n "1,40p" "$LATEST/TOP_SPAM.tsv"; } || true
'
+ echo '- LOG  : reports_auto/panic_20250920T163743/run.log'
+ echo '- ERR  : reports_auto/panic_20250920T163743/run.err'
+ echo '- PY   : reports_auto/panic_20250920T163743/python_stderr.txt'
+ echo '- OOM  : reports_auto/panic_20250920T163743/oom.txt'
+ echo '- TRACE: reports_auto/panic_20250920T163743/xtrace.sh'
+ echo '- SYS  : reports_auto/panic_20250920T163743/system.txt'
+ echo
+ echo '## Heuristics'
+ grep -qi 'only one class' reports_auto/panic_20250920T163743/run.err reports_auto/panic_20250920T163743/python_stderr.txt
+ grep -qi 'No module named '\''tools'\''' reports_auto/panic_20250920T163743/run.err reports_auto/panic_20250920T163743/python_stderr.txt
+ grep -qi 'Can'\''t get attribute '\''rules_feat' reports_auto/panic_20250920T163743/run.err reports_auto/panic_20250920T163743/python_stderr.txt
+ grep -qi Killed reports_auto/panic_20250920T163743/run.err reports_auto/panic_20250920T163743/python_stderr.txt
+ grep -qi 'out of memory' reports_auto/panic_20250920T163743/oom.txt
+ echo
+ echo '=== DIAG OUTPUTS ==='
+ printf '%s\n' reports_auto/panic_20250920T163743/REPORT.md reports_auto/panic_20250920T163743/run.log reports_auto/panic_20250920T163743/run.err reports_auto/panic_20250920T163743/python_stderr.txt reports_auto/panic_20250920T163743/xtrace.sh reports_auto/panic_20250920T163743/system.txt reports_auto/panic_20250920T163743/oom.txt
+ echo
+ exit 1
