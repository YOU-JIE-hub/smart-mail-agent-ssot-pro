...
# 寫入一次性 Python（只放在本次 OUT 目錄，不改專案檔）
...
def dumps(x): return json.dumps(x, ensure_ascii=False, indent=2, default=_json_sanitize)
...
python3 "$OUT/forensics.py"
'
++ tee -a reports_auto/panic_20250920T172429/python_stderr.txt
+ ec=1
+ set -e
...
python3 "$OUT/forensics.py"
'
+ echo '- LOG  : reports_auto/panic_20250920T172429/run.log'
+ echo '- ERR  : reports_auto/panic_20250920T172429/run.err'
+ echo '- PY   : reports_auto/panic_20250920T172429/python_stderr.txt'
+ echo '- OOM  : reports_auto/panic_20250920T172429/oom.txt'
+ echo '- TRACE: reports_auto/panic_20250920T172429/xtrace.sh'
+ echo '- SYS  : reports_auto/panic_20250920T172429/system.txt'
+ echo
+ echo '## Heuristics'
+ grep -qi 'only one class' reports_auto/panic_20250920T172429/run.err reports_auto/panic_20250920T172429/python_stderr.txt
+ grep -qi 'No module named '\''tools'\''' reports_auto/panic_20250920T172429/run.err reports_auto/panic_20250920T172429/python_stderr.txt
+ grep -qi 'Can'\''t get attribute '\''rules_feat' reports_auto/panic_20250920T172429/run.err reports_auto/panic_20250920T172429/python_stderr.txt
+ grep -qi Killed reports_auto/panic_20250920T172429/run.err reports_auto/panic_20250920T172429/python_stderr.txt
+ grep -qi 'out of memory' reports_auto/panic_20250920T172429/oom.txt
+ echo
+ echo '=== DIAG OUTPUTS ==='
+ printf '%s\n' reports_auto/panic_20250920T172429/REPORT.md reports_auto/panic_20250920T172429/run.log reports_auto/panic_20250920T172429/run.err reports_auto/panic_20250920T172429/python_stderr.txt reports_auto/panic_20250920T172429/xtrace.sh reports_auto/panic_20250920T172429/system.txt reports_auto/panic_20250920T172429/oom.txt
+ echo
+ exit 1
