...
+ true
+ set +e
+ timeout --preserve-status 3h bash -lc 'python3 - <<'\''__PY__'\''
import os, sys, json, time, re, shutil, hashlib, subprocess as sp
from pathlib import Path
...
print('\''[DONE] summary.md  :'\'', out_dir/'\''summary.md'\'')
__PY__'
++ tee -a reports_auto/panic_20250921T122045/python_stderr.txt
+ ec=1
+ set -e
...
print('\''[DONE] summary.md  :'\'', out_dir/'\''summary.md'\'')
__PY__'
+ echo '- LOG  : reports_auto/panic_20250921T122045/run.log'
+ echo '- ERR  : reports_auto/panic_20250921T122045/run.err'
+ echo '- PY   : reports_auto/panic_20250921T122045/python_stderr.txt'
+ echo '- OOM  : reports_auto/panic_20250921T122045/oom.txt'
+ echo '- TRACE: reports_auto/panic_20250921T122045/xtrace.sh'
+ echo '- SYS  : reports_auto/panic_20250921T122045/system.txt'
+ echo
+ echo '## Heuristics'
+ grep -qi JSONDecodeError reports_auto/panic_20250921T122045/run.err reports_auto/panic_20250921T122045/python_stderr.txt
+ grep -qi 'Permission denied' reports_auto/panic_20250921T122045/run.err reports_auto/panic_20250921T122045/python_stderr.txt
+ grep -qi Killed reports_auto/panic_20250921T122045/run.err reports_auto/panic_20250921T122045/python_stderr.txt
+ grep -qi 'only one class' reports_auto/panic_20250921T122045/run.err reports_auto/panic_20250921T122045/python_stderr.txt
+ echo -e '\n=== DIAG OUTPUTS ===\nreports_auto/panic_20250921T122045/REPORT.md\nreports_auto/panic_20250921T122045/run.log\nreports_auto/panic_20250921T122045/run.err\nreports_auto/panic_20250921T122045/python_stderr.txt\nreports_auto/panic_20250921T122045/xtrace.sh\nreports_auto/panic_20250921T122045/system.txt\nreports_auto/panic_20250921T122045/oom.txt\n'
+ exit 1
