...
def run_e2e_mail(eml_dir: str, out_dir: str, db_path: str = "db/sma.sqlite", ndjson_path: str = "reports_auto/logs/pipeline.ndjson") -> None:
    """
    ...
    # legacy runner 只吃 eml_dir；其餘用預設（會寫到 reports_auto/e2e_mail/<ts>/）
