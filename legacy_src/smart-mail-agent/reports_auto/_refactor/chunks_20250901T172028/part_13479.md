hields.io/github/actions/workflow/status/YOU-JIE-hub/smart-mail-agent/lint.yml?branch=hardening/pro-release-20250821-060514&label=lint"></a>
...
def run_payload(payload: Dict[str, Any], whitelist: bool=False, dry_run: bool=False, simulate_failure: st