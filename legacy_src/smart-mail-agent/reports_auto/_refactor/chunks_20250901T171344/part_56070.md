d({"nlp": analyze_text(texts, cfg.get("nlp", {}).get("model", "offline-keyword"))})
...
def run_ocr(image_path: str) -> Dict[str, str]:
    ...
    try:
        ...
        return {"path": image_path, "text": ""}
--- END FILE: share/export/20250822T205347Z/code_snapshot_part08.txt ---

--- BEGIN FILE: share/export/20250822T205347Z/code_snapshot_part09.txt ---
...
def choose_package(subject: str, body: str) -> Dict[str, Any]:
    ...
    manual_hint = bool(re.search(r"(人工|手動|手动|