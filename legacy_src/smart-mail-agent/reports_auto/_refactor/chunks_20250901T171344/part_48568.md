alid_for_json_schema(schema, f'core_schema.IsInstanceSchema ({schema["cls"]})')
   856
  ...
  1266	            # more than one possible attribute, and looks for whether a single alias choice is present as a documente