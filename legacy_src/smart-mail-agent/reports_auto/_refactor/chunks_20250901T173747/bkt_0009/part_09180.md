...
tox.ini
--- END FILE: _audit/git_files.txt ---

--- BEGIN FILE: _audit/python_files.txt ---
examples/legacy_lowcov/src/actions/__init__.py
examples/legacy_lowcov/src/email_processor.py
examples/legacy_lowcov/src/inference_classifier.py
examples/legacy_lowcov/src/log_writer.py
...
tests/unit/test_utils_pdf_safe_top.py
tools/run_actions_matrix.py
--- END FILE: _audit/python_files.txt ---

--- BEGIN FILE: _audit/restored_from_base.txt ---
--- END FILE: _audit/restored_from_base.txt ---

--- BEGIN FILE: _audit/snapshot.txt ---
>>> TREE
...
>>> PY COUNTS
     ...
     11 smart_mail_agent/spam
      ...
      1 ai_rpa/actions.py
--- END FILE: _audit/snapshot.txt ---

--- BEGIN FILE: _audit/support_bundle.txt ---
