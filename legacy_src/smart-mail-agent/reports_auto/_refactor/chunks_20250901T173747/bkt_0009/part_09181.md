...
echo "— 全部測試（允許失敗，先觀察）—"
pytest -q || true
--- END FILE: apply_full_suite_fixes.sh ---

--- BEGIN FILE: apply_patch_r9.py ---
from __future__ import annotations
...
if __name__ == "__main__":
    main()
--- END FILE: apply_patch_r9.py ---

--- BEGIN FILE: apply_quotation_and_cli_fixes.sh ---
#!/usr/bin/env bash
set -Eeuo pipefail
