xamples/legacy_lowcov/src/smart_mail_agent/spam/feature_extractor.py ---
#!/usr/bin/env python3
...
def extract_features(raw_email: str) -> dict[str, int]:
    ...
    return features
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/spam/feature_extractor.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/spam/ml_spam_classifier.py ---
#!/usr/bin/env python3
# mypy: ignore-errors
...
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/spam/ml_spam_classifier.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/spam/pipeline.py ---
...
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/spam/pipeline.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/spam/rule_filter.py ---
#!/usr/bin/env python3
...
class RuleBasedSpamFilter:
    ...
    def is_spam(self, text: str) -> bool:
        ...
        return False
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/spam/rule_filter.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/spam/rules.py ---
from __future__ import annotations
...
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/spam/rules.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/spam/spam_llm_filter.py ---
import os
...
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/spam/spam_llm_filter.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/config.py ---
from __future__ import annotations
...
SETTINGS = Settings()
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/config.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/db_tools.py ---
#!/usr/bin/env python3
...
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/db_tools.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/env.py ---
from __future__ import annotations
...
def get_bool(keys, default=False):
    ...
    return default
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/env.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/errors.py ---
from __future__ import annotations
...
class InternalError(Exception):
    ...
    pass
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/errors.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/font_check.py ---
from __future__ import annotations
...
def ensure_font_available(logger=None) -> str | None:
    ...
    if fp is None:
        ...
        return None
    return fp
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/font_check.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/fonts.py ---
#!/usr/bin/env python3
from __future__ import annotations
...
def find_font(root: str | Path = ".") -> str | None:
    ...
    for name in PREFERRED:
        ...
        if p.is_file():
            return str(p)
    return None
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/fonts.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/imap_folder_detector.py ---
import imaplib
import os
import re
...
def detect_all_mail_folder() -> str:
    ...
    try:
        ...
        return "INBOX"
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/imap_folder_detector.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/imap_login.py ---
from __future__ import annotations
...
def get_imap():
    ...
    return imap
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/imap_login.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/jsonlog.py ---
from __future__ import annotations
...
def log_event(result: Any, request: dict[str, Any] | None = None) -> str:
    ...
    try:
        ...
        try:
            ...
            pass
        return ""
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/jsonlog.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/log_writer.py ---
from __future__ import annotations
...
__all__ = ["log_to_db"]
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/log_writer.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/logging_setup.py ---
from __future__ import annotations
...
def setup_logging(level: str | int = None) -> logging.Logger:
    ...
    logger.setLevel(lvl)
    return logger
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/logging_setup.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/pdf_generator.py ---
import os
...
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/pdf_generator.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/priority_evaluator.py ---
#!/usr/bin/env python3
...
def evaluate_priority(
    ...
    try:
        ...
        return "medium"
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/priority_evaluator.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/rag_reply.py ---
import os
...
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/rag_reply.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/templater.py ---
from __future__ import annotations
...
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/templater.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/tracing.py ---
from __future__ import annotations
...
def trace_decision(root: Path, name: str, payload: dict[str, Any]) -> Path:
    ...
    return p
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/tracing.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/validators.py ---
from __future__ import annotations
...
def check_attachments(names: Iterable[str]) -> tuple[bool, str]:
    ...
    return True, "OK"
--- END FILE: examples/legacy_lowcov/src/smart_mail_agent/utils/validators.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/spam/feature_extractor.py ---
...
--- END FILE: examples/legacy_lowcov/src/spam/feature_extractor.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/spam/ml_spam_classifier.py ---
...
for _k in dir(_mod):
    if not _k.startswith("_"):
        globals()[_k] = getattr(_mod, _k)
--- END FILE: examples/legacy_lowcov/src/spam/ml_spam_classifier.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/spam/rule_filter.py ---
...
for _k in dir(_mod):
    if not _k.startswith("_"):
        globals()[_k] = getattr(_mod, _k)
--- END FILE: examples/legacy_lowcov/src/spam/rule_filter.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/spam/rules.py ---
...
for _k in dir(_mod):
    if not _k.startswith("_"):
        globals()[_k] = getattr(_mod, _k)
--- END FILE: examples/legacy_lowcov/src/spam/rules.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/support_ticket.py ---
#!/usr/bin/env python3
...
if __name__ == "__main__":
    main()
--- END FILE: examples/legacy_lowcov/src/support_ticket.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/train_classifier.py ---
import json
...
--- END FILE: examples/legacy_lowcov/src/train_classifier.py ---

--- BEGIN FILE: examples/legacy_lowcov/src/utils/jsonlog.py ---
"""Compatibility proxy to canonical implementation."""

from smart_mail_agent.utils.jsonlog import log_event  # noqa: F401
--- END FILE: examples/legacy_lowcov/src/utils/jsonlog.py ---

--- BEGIN FILE: features/__init__.py ---
# package marker
--- END FILE: features/__init__.py ---

--- BEGIN FILE: features/quotation.py ---
# -*- coding: utf-8 -*-
from __future__ import annotations
...
--- END FILE: features/quotation.py ---

--- BEGIN FILE: finalize_sma.sh ---
#!/usr/bin/env bash
set -Eeuo pipefail
...
--- END FILE: finalize_sma.sh ---

--- BEGIN FILE: fix_lint_and_test.sh ---
#!/usr/bin/env bash
set -Eeuo pipefail
...
--- END FILE: fix_lint_and_test.sh ---

--- BEGIN FILE: fix_lint_and_test_v2.sh ---
#!/usr/bin/env bash
set -Eeuo pipefail
trap 'echo "❌ 失敗於第 $LINENO 行（exit=$?）" >&2' ERR
...
echo "— CLI sanity —"
python -S -m smart_mail_agent.cli.sma --version
--- END FILE: fix_lint_and_test_v2.sh ---

--- BEGIN FILE: fix_lint_and_test_v3.sh ---
#!/usr/bin/env bash
set -Eeuo pipefail
trap 'echo "❌ 失敗於第 $LINENO 行（exit=$?）" >&2' ERR
