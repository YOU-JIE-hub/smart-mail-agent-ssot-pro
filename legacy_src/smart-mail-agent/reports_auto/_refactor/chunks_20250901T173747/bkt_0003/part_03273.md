...
echo "✅ 所有修補檔已寫入。"
--- END FILE: apply_all_fixes.sh ---

--- BEGIN FILE: apply_core_fixes.sh ---
#!/usr/bin/env bash
set -Eeuo pipefail
...
--- END FILE: apply_core_fixes.sh ---

--- BEGIN FILE: apply_email_processor_and_testpkg_fixes.sh ---
#!/usr/bin/env bash
set -Eeuo pipefail
trap 'echo "❌ 失敗於第 $LINENO 行（exit=$?）" >&2' ERR
...
--- END FILE: apply_email_processor_and_testpkg_fixes.sh ---

--- BEGIN FILE: apply_full_suite_fixes.sh ---
#!/usr/bin/env bash
set -Eeuo pipefail
trap 'echo "❌ 失敗於第 $LINENO 行（exit=$?）" >&2' ERR
