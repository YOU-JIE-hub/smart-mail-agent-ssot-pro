...
   
<listcomp>        z+test_users_table_schema.<locals>.<listcomp>)emailnamephoneaddressinz%(py0)s in %(py2)sr   columnspy0py2assert %(py4)spy4Nr   sqlite3connectr