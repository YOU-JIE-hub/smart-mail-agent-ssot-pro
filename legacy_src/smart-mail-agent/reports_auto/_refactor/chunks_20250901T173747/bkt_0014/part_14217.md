thon3.10/site-packages/setuptools/_distutils/command/install_egg_info.py
...
<<< CONTENT-END
----- FILE-END :: export/code_part_04.md

----- FILE-START :: export/code_part_002.md
GROUP: normal
SHA256: 0ecb2934ac231ca2e59fa3bcf55454eae2a94cb42457d4d0dadb31f61df1f7c4
GIT_UNIX_TS: N/A
CONTENT-BEGIN >>>
...
def add_forward(body, lang="en"):
    if lang=="en":
        hdr = f"----- Forwarded message -----\nFrom: {en_name()} <notice@{random.choice(PHISH_BASE)}.{random