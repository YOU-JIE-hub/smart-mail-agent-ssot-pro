...
--- BEGIN FILE: src/smart_mail_agent/spam/__init__.py ---
# shim package for backward compatibility
--- END FILE: src/smart_mail_agent/spam/__init__.py ---

--- BEGIN FILE: src/smart_mail_agent/spam/feature_extractor.py ---
#!/usr/bin/env python3
...
--- BEGIN FILE: src/smart_mail_agent/spam/filter.py ---
from __future__ import annotations
...
class SpamFilterOrchestrator:
    ...
    def score(self, subject: str, content: str, sender: str) -> Tuple[float, Dict]:
        ...
        return score, result
--- END FILE: src/smart_mail_agent/spam/filter.py ---

--- BEGIN FILE: src/smart_mail_agent/spam/inference_classifier.py ---
#!/usr/bin/env python3
...
--- END FILE: src/smart_mail_agent/spam/inference_classifier.py ---

--- BEGIN FILE: src/smart_mail_agent/spam/ml_spam_classifier.py ---
#!/usr/bin/env python3
...
--- BEGIN FILE: src/smart_mail_agent/spam/offline_orchestrator/__init__.py ---
...
--- END FILE: src/smart_mail_agent/spam/offline_orchestrator/__init__.py ---

--- BEGIN FILE: src/smart_mail_agent/spam/offline_orchestrator/deprecated.py ---
...
try:
    ...
    pass
--- END FILE: src/smart_mail_agent/spam/offline_orchestrator/deprecated.py ---

--- BEGIN FILE: src/smart_mail_agent/spam/orchestrator.py ---
from __future__ import annotations
...
class SpamFilterOrchestrator:
    ...
    def is_legit(self, subject: str, content: str, sender: str = "") -> Dict[str, object]:
        ...
        return r
--- END FILE: src/smart_mail_agent/spam/orchestrator.py ---

--- BEGIN FILE: src/smart_mail_agent/spam/orchestrator_offline/__init__.py ---
# compat package created by AP-26-FIX
# This mirrors a historical filename with a dot (e.g. offline_orchestrator.deprecated.py).
# Real functionality lives in smart_mail_agent.spam.spam_filter_orchestrator.
--- END FILE: src/smart_mail_agent/spam/orchestrator_offline/__init__.py ---

--- BEGIN FILE: src/smart_mail_agent/spam/orchestrator_offline/deprecated.py ---
"""Deprecated shim module.
...
try:
    ...
    pass
--- END FILE: src/smart_mail_agent/spam/orchestrator_offline/deprecated.py ---

--- BEGIN FILE: src/smart_mail_agent/spam/pipeline.py ---
from __future__ import annotations
...
--- BEGIN FILE: src/smart_mail_agent/spam/rule_filter.py ---
#!/usr/bin/env python3
from __future__ import annotations
...
--- BEGIN FILE: src/smart_mail_agent/spam/rules.py ---
from __future__ import annotations
...
def generate_info_change_pdf(info_dict: dict, save_path: str):
    ...
    try:
        ...
        c.save()
        logger.info("[PDFGenerator] PDF 已產出